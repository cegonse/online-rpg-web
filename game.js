...
Module['FS_createPath']("/resources", "rooms", true, true);
    ...
    loadPackage({"files": [{"filename": "/resources/bot.glb", "start": 0, "end": 2239928}, {"filename": "/resources/button_press.glb", "start": 2239928, "end": 2330984}, {"filename": "/resources/cast_spell.glb", "start": 2330984, "end": 2422664}, {"filename": "/resources/dance1.glb", "start": 2422664, "end": 2992860}, {"filename": "/resources/dance2.glb", "start": 2992860, "end": 3099840}, {"filename": "/resources/death.glb", "start": 3099840, "end": 3194868}, {"filename": "/resources/drinking.glb", "start": 3194868, "end": 3281736}, {"filename": "/resources/friendly_target.png", "start": 3281736, "end": 3291946}, {"filename": "/resources/hit.glb", "start": 3291946, "end": 3366258}, {"filename": "/resources/idle.glb", "start": 3366258, "end": 3471834}, {"filename": "/resources/idle_affected_state.glb", "start": 3471834, "end": 3687854}, {"filename": "/resources/kick1.glb", "start": 3687854, "end": 3782102}, {"filename": "/resources/kick2.glb", "start": 3782102, "end": 3863718}, {"filename": "/resources/revive.glb", "start": 3863718, "end": 4033294}, {"filename": "/resources/rooms/obj_room00.glb", "start": 4033294, "end": 4100650}, {"filename": "/resources/rooms/room00.glb", "start": 4100650, "end": 4152326}, {"filename": "/resources/rooms/room01_floor.glb", "start": 4152326, "end": 4163510}, {"filename": "/resources/running.glb", "start": 4163510, "end": 4236806}, {"filename": "/resources/stand_from_critical.glb", "start": 4236806, "end": 4341358}, {"filename": "/resources/test_level.glb", "start": 4341358, "end": 4349606}, {"filename": "/resources/unfriendly_target.png", "start": 4349606, "end": 4360819}, {"filename": "/resources/walk_affected_state.glb", "start": 4360819, "end": 4502783}, {"filename": "/resources/walking.glb", "start": 4502783, "end": 9765535}], "remote_package_size": 9765535});

  })();

// end include: /tmp/tmp4ycjm_kw.js
// include: /tmp/tmpbgb4s451.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpbgb4s451.js
// include: /tmp/tmp5ocj_qb_.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp5ocj_qb_.js
...
var ASM_CONSTS = {
  128255: () => { if (document.fullscreenElement) return 1; },  
 128301: () => { return document.getElementById('canvas').width; },  
 128353: () => { return parseInt(document.getElementById('canvas').style.width); },  
 128421: () => { document.exitFullscreen(); },  
 128448: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 128521: () => { if (document.fullscreenElement) return 1; },  
 128567: () => { return document.getElementById('canvas').width; },  
 128619: () => { return screen.width; },  
 128644: () => { document.exitFullscreen(); },  
 128671: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 128804: () => { return window.innerWidth; },  
 128830: () => { return window.innerHeight; },  
 128857: () => { if (document.fullscreenElement) return 1; },  
 128903: () => { return document.getElementById('canvas').width; },  
 128955: () => { return parseInt(document.getElementById('canvas').style.width); },  
 129023: () => { if (document.fullscreenElement) return 1; },  
 129069: () => { return document.getElementById('canvas').width; },  
 129121: () => { return screen.width; },  
 129146: () => { return window.innerWidth; },  
 129172: () => { return window.innerHeight; },  
 129199: () => { if (document.fullscreenElement) return 1; },  
 129245: () => { return document.getElementById('canvas').width; },  
 129297: () => { return screen.width; },  
 129322: () => { document.exitFullscreen(); },  
 129349: () => { if (document.fullscreenElement) return 1; },  
 129395: () => { return document.getElementById('canvas').width; },  
 129447: () => { return parseInt(document.getElementById('canvas').style.width); },  
 129515: () => { document.exitFullscreen(); },  
 129542: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 129600: () => { return screen.width; },  
 129625: () => { return screen.height; },  
 129651: () => { return window.screenX; },  
 129678: () => { return window.screenY; },  
 129705: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 129758: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 129829: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 129886: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 130142: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 130213: () => { if (document.fullscreenElement) return 1; },  
 130259: () => { return window.innerWidth; },  
 130285: () => { return window.innerHeight; },  
 130312: () => { if (document.pointerLockElement) return 1; }
};
